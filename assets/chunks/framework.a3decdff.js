...
const assetsURL = function(dep) {
  return "/smart-flow-ai-skill-platform-doc/" + dep;
};
const seen = {};
...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/smart-flow-ai-skill-platform-doc/";
...
export {
  ...
  EXTERNAL_URL_RE as H,
  useRoute as I,
  mergeProps as J,
  inject as K,
  normalizeStyle as L,
  nextTick as M,
  useWindowScroll as N,
  ...
  computedAsync as af,
  useSessionStorage as ag,
  useLocalStorage as ah,
  watchDebounced as ai,
  useRouter as aj,
