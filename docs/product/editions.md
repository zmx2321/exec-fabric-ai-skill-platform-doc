...
<div class="brand-page-shell brand-page-shell--editions">
  <section class="brand-hero">
    <div>
      ...
      <p class="brand-lead">
        <strong>当前 <code>1.0</code> 的核心定位是：璇络(ExecFabric)是一个以 Python 脚本为第一种成熟执行资产的多租户能力治理与执行平台。</strong>
      </p>
      <p class="brand-lead">
      ...
      <p class="brand-lead">
        ...
        第一种非脚本能力样板是平台治理控制台的 <code>HTTP 能力接入</code>。
        但下一步优先级仍然不是横向铺更多能力，而是先把 <code>1.1</code> 的自动注册、支付、续费和停开恢复做成低客服闭环。
      </p>
      <p class="brand-lead">
        这一轮也进一步收紧了边界：
        <code>HTTP 能力接入</code> 继续只在平台治理域开放，
        白名单租户 admin 只保留最小跨租户控制台；
        同时系统也不再用 <code>user_id == 1</code> 这种条件去误判管理员。
      </p>
      <p class="brand-lead">
        当前 <code>1.1</code> 已先落下一段真实骨架：平台治理控制台订单中心支持建单、确认支付、执行开通、续费提醒扫描、到期停开扫描；
        璇络个人免费版也已经接通本地脚本位账单中心第一版，免费页还增加了团队版月租 / 年租注册入口说明。
        但完整通用订阅中心、真实第三方支付网关和外发提醒渠道仍未完成。
      </p>
      <p class="brand-lead">
        同时，璇络标准 SaaS 共享租户前端骨架也已经建立：进入标准 SaaS 共享租户号段后，标准 SaaS 客户不再默认一客户复制一套前端工程，
        而是优先走共享租户前端。它当前已经能承接正式租户入口，但动态品牌化、初始化和更细定制边界还在继续收口。
      </p>
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>平台治理控制台已先落一版 HTTP 能力接入样板，租户侧只开放只读台账</li>
        <li>白名单租户 admin 当前只开放最小跨租户控制台，不直接开放平台治理页</li>
        <li>管理员判定已按显式 admin / 超管标记收口，不再依赖 <code>user_id == 1</code></li>
        <li>智能大脑推荐、确认、执行、审计</li>
        <li>模板分发、安装、回滚、日志</li>
        <li>免登录体验页、登录 / 注册 / 注册结果页，以及“我的技能库 / 上传脚本 / 智能助手 / 执行历史 / 个人空间 / 公告中心 / 社区广场 / 升级正式版”这组璇络个人免费版有效菜单、HTTP 只读台账、本地脚本位轻量自助增购和 <code>execfabric-cli</code> 最小闭环</li>
      </ul>
    </article>
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>把真实第三方支付、外发提醒、共享 SaaS 品牌化和剩余生命周期自动化继续收口成稳定口径</li>
      </ul>
    </article>
  </section>
...
<section class="brand-grid brand-grid--two">
  <article class="brand-card">
    ...
    <ul class="brand-list">
      <li>平台治理控制台订单中心已经切到真实生命周期模式</li>
      <li>已支持建单、确认支付、执行开通、续费单预填、续费提醒扫描、到期停开扫描</li>
      <li>璇络个人免费版前台已经接通本地脚本位轻量自助增购，并开放团队版月租 / 年租注册入口说明</li>
  ...
  <article class="brand-card">
    ...
    <ul class="brand-list">
      <li>璇络个人免费版完整通用订阅中心、终端用户自助续费 / 自动扣款入口和更深对账能力</li>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>本地脚本位增购</td>
        <td>个人空间轻量扩容</td>
        <td>属于 1.1 已落地的第一段闭环，不等于完整通用订阅中心</td>
...
<section class="brand-card">
  ...
  <div class="brand-grid brand-grid--four">
    <article class="brand-card brand-card--nested">
      <h3>01. 免费入口感知价值</h3>
      <p>先通过公开体验页、登录 / 注册 / 注册结果页和免费入口理解平台是什么；登录后的个人入口当前会继续落到“我的技能库 / 上传脚本 / 智能助手 / 执行历史 / 个人空间 / 公告中心 / 社区广场 / 升级正式版”这组有效菜单，以及 HTTP 只读台账和本地脚本位轻量扩容入口，确认“AI 调度能力”这条链路是否成立。</p>
    </article>
    <article class="brand-card brand-card--nested">
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>因此当前路线保持为：正式客户交付 <code>1.0</code> 承接正式场景，璇络个人免费版承接体验与升级入口，两条线共用同一套可信执行底座</li>
      </ul>
    </article>
    <article class="brand-card">
