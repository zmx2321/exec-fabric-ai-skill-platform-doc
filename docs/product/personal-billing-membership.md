...
<div class="brand-page-shell brand-page-shell--editions">
  <section class="brand-hero">
    <div>
      ...
      <p class="brand-lead">
        ...
        如果你准备进入正式协作，优先走<strong>团队版月租 / 年租</strong>入口，
      ...
      <div class="brand-grid brand-grid--single">
        ...
        <article class="brand-hero__panel">
          ...
          <ul class="brand-list">
            ...
            <li>不能把免费页说成已经自己完成正式团队租户的注册、付款、开通和续费闭环。</li>
            <li>不能把正式租户的月费 / 年费价格写死在这页，因为最终价格和付款口径以目标租户端当页展示为准。</li>
          </ul>
        </article>
      </div>
    </div>
    ...
    <div class="brand-grid brand-grid--two">
      ...
      <article class="brand-card brand-card--nested">
        ...
        <ul class="brand-list">
          ...
          <li>真正的正式付款页、价格和服务周期，以目标租户端注册页当页展示为准。</li>
  ...
  <section class="brand-card">
    ...
    <h2>免费页、本地脚本位增购、月费 / 年费会员分别有什么好处</h2>
...
| 团队版年租 | 已明确长期使用的团队 | 正式租户周期更稳，减少月度反复续期开通动作 | 仍不是私有化默认入口，涉及更深边界建议直接沟通 |
  ...
  <section class="brand-card">
    ...
    <ul class="brand-list">
      ...
      <li>更准确的公开口径是：<strong>个人账单中心第一版 + 正式租户注册升级路径已经成立，完整通用计费中心仍在继续收敛。</strong></li>
    </ul>
  </section>
