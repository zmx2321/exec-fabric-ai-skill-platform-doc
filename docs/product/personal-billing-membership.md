...
<div class="brand-page-shell brand-page-shell--editions">
  <section class="brand-hero">
    <div>
      ...
      <div class="brand-hero__panel">
        ...
        <strong>当前已经可以对外明确讲清楚两条路径：璇络个人免费版本地脚本位自助增购，以及从璇络个人免费版跳到标准 SaaS 正式租户入口的团队版月租 / 年租方案入口。</strong>
        <p>这页专门回答：个人免费页怎么付款、团队版月租 / 年租方案入口怎么进入、升级后能得到什么，以及当前哪些能力已经完成、哪些还没完成。</p>
      </div>
      <p class="brand-lead">
        如果你现在只是个人探索，优先走<strong>个人账单与脚本位</strong>；
        如果你准备进入正式协作，优先走<strong>团队版月租 / 年租方案入口</strong>，
    ...
    <div class="brand-hero__media brand-hero__media--compact">
      <div class="brand-grid brand-grid--single">
        ...
        <article class="brand-hero__panel">
          ...
          <strong>当前还不能怎么讲</strong>
          <ul class="brand-list">
            <li>不能把个人免费页说成“完整通用支付中心”。</li>
            <li>不能把当前支付说成“已经全面接通正式第三方网关”。</li>
            <li>不能把免费页说成已经自己完成正式团队租户的注册、在线支付、开通和续费闭环。</li>
            <li>不能把正式租户的月费 / 年费价格写死在这页，因为最终价格、是否在线支付和正式服务周期都以目标租户端当前配置为准。</li>
          </ul>
        </article>
      </div>
    </div>
  ...
  <section class="brand-grid brand-grid--three">
    ...
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>两条路径都会跳到标准 SaaS 正式租户登记页，当前由共享租户前端承接开通判断入口，不再继续留在个人免费隐藏租户里。</li>
      </ul>
    </article>
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>团队版月租 / 年租的最终价格、是否开放在线支付和正式服务周期，以目标正式租户页当前配置为准。</li>
  ...
  <section class="brand-card">
    ...
    <div class="brand-grid brand-grid--two">
      ...
      <article class="brand-card brand-card--nested">
        <h3>付款后你会得到什么</h3>
        <ul class="brand-list">
          <li>你可以继续在个人免费空间里上传更多本地脚本，不必先切到正式租户。</li>
          <li>“上传脚本 / 执行历史 / 公告中心 / 个人空间”和 CLI 指引这条个人探索路径可以继续保持连贯。</li>
          <li>这条路径更适合“先扩个人能力位”，而不是直接进入多人正式协作。</li>
          <li>当前这笔费用只购买本地脚本位，不等于开通正式团队版或企业版。</li>
        </ul>
      </article>
    </div>
  </section>
  ...
  <section class="brand-card">
    ...
    <div class="brand-grid brand-grid--two">
      ...
      <article class="brand-card brand-card--nested">
        <h3>当前要特别注意</h3>
        <ul class="brand-list">
          <li>这页负责讲清楚“怎么注册”和“为什么升级”，不直接承诺固定月费 / 年费价格。</li>
          <li>是否开放正式在线支付、价格和服务周期，以目标租户端当前页配置为准。</li>
          <li>如果你已经是企业客户，通常更适合直接沟通交付与部署边界，而不是走标准月租入口。</li>
        </ul>
      </article>
    </div>
  </section>
  ...
  <section class="brand-card">
    ...
    <h2>免费页、本地脚本位增购、团队版月租 / 年租方案分别有什么好处</h2>
...
| 团队版月租 | 想先用一个月验证正式协作的人 | 切到标准 SaaS 正式租户方案入口，开始正式多人协作和更稳定的租户使用 | 最终价格、是否在线支付和服务周期以目标租户端当前配置为准 |
