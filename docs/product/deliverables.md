...
<div class="brand-page-shell brand-page-shell--deliverables">
  <section class="brand-hero">
    <div>
      ...
      <p class="brand-lead">
        璇络(ExecFabric)的标准交付通常包括：
        <strong>一个独立访问入口 + 一组客户专属能力 + 一套可继续使用和更新的说明入口。</strong>
        也就是说，交付物不只是一张账号表，还包括
        <strong>结果入口、公告入口、客户说明和后续更新说明。</strong>
      </p>
      <div class="brand-chip-list">
        <span class="brand-chip">独立网址</span>
        <span class="brand-chip">账号与权限</span>
        <span class="brand-chip">客户说明</span>
      ...
      <div class="matrix-panel matrix-panel--contact">
        ...
        <div class="matrix-panel__canvas">
          ...
          <div class="matrix-panel__stack">
            <span class="matrix-panel__line"><span class="matrix-panel__kw">const</span> <span class="matrix-panel__ident">deliveryKit</span> <span class="matrix-panel__op">=</span> <span class="matrix-panel__punct">[</span><span class="matrix-panel__string">'site_url'</span><span class="matrix-panel__punct">,</span> <span class="matrix-panel__string">'account'</span><span class="matrix-panel__punct">,</span> <span class="matrix-panel__string">'docs_entry'</span><span class="matrix-panel__punct">,</span> <span class="matrix-panel__string">'result_entry'</span><span class="matrix-panel__punct">]</span></span>
            <span class="matrix-panel__line"><span class="matrix-panel__kw">const</span> <span class="matrix-panel__ident">supportEntry</span> <span class="matrix-panel__op">=</span> <span class="matrix-panel__punct">[</span><span class="matrix-panel__string">'platform_notice'</span><span class="matrix-panel__punct">,</span> <span class="matrix-panel__string">'tenant_notice'</span><span class="matrix-panel__punct">,</span> <span class="matrix-panel__string">'update_guide'</span><span class="matrix-panel__punct">]</span></span>
            <span class="matrix-panel__line"><span class="matrix-panel__kw">const</span> <span class="matrix-panel__ident">handoffGoal</span> <span class="matrix-panel__op">=</span> <span class="matrix-panel__string">'usable_after_go_live'</span></span>
          </div>
          <div class="matrix-panel__callout">HANDOVER SHOULD STAY USABLE</div>
        </div>
        <div class="matrix-panel__footer">
          <span class="matrix-panel__tag"><span class="matrix-panel__key">scope</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">customer_safe</span></span>
          <span class="matrix-panel__tag"><span class="matrix-panel__key">entry</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">clear</span></span>
          <span class="matrix-panel__tag"><span class="matrix-panel__key">docs</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">included</span></span>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="brand-grid brand-grid--four">
    <article class="brand-card">
      ...
      <h2>独立访问入口</h2>
      <p>客户拿到自己的网址和登录入口，而不是和其他客户混在一起的统一后台。</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">02</p>
      <h2>账号与基础权限</h2>
      <p>客户拿到能进入自己空间的账号和权限边界，而不是超管视角的全平台权限。</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">03</p>
      <h2>说明文档入口</h2>
      <p>客户会拿到如何使用、如何继续更新、如何查看公告或文档入口的说明。</p>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">04</p>
      <h2>结果与产物入口</h2>
      <p>如果项目包含文件处理或结果导出，交付物里也应包含结果查看和结果下载入口。</p>
    </article>
  </section>
  ...
  <section class="brand-card">
    ...
    <table class="deliverables-table">
      ...
      <tbody>
        ...
        <tr>
          <td>公告 / 文档入口</td>
          <td>公告入口、客户须知或其他文档入口</td>
          <td>承接客户长期使用信息</td>
          <td>按项目开放</td>
        </tr>
        <tr>
          <td>文件上传 / 结果下载入口</td>
          <td>上传输入文件、查看状态、下载结果</td>
          <td>承接文件型任务</td>
          <td>按项目开放</td>
        </tr>
      </tbody>
  ...
  <section class="brand-grid brand-grid--two">
    <article class="brand-card">
      <p class="brand-kicker">Document Entry</p>
      <h2>这些文档入口分别是干什么的</h2>
      <ul class="brand-list">
        <li>客户使用说明：告诉客户如何登录、执行、查看结果。</li>
        <li>客户脚本热更新说明：告诉客户后续怎么提新增或更新需求。</li>
        <li>公告或客户须知入口：承接上线后长期使用说明，而不是只靠聊天记录。</li>
        <li>如果项目包含文件处理，还需要明确结果查看和下载入口。</li>
      </ul>
    </article>
    <article class="brand-card">
  ...
  <section class="brand-card">
    <p class="brand-kicker">After Go-Live</p>
    <h2>上线后，客户和平台各自负责什么</h2>
    <div class="brand-grid brand-grid--two">
      <article class="brand-card brand-card--nested">
        <h3>客户侧</h3>
        <ul class="brand-list">
          <li>登录自己的入口并按授权范围使用能力。</li>
          <li>根据结果确认业务是否达到预期。</li>
          <li>如需更新脚本或补能力，按正式说明提需求。</li>
        </ul>
      </article>
      <article class="brand-card brand-card--nested">
        <h3>平台侧</h3>
        <ul class="brand-list">
          <li>保证租户边界、权限边界和执行边界。</li>
          <li>负责审核、注册、授权和后续更新流程。</li>
          <li>按项目范围维护公告、文档和结果入口。</li>
        </ul>
      </article>
    </div>
  </section>
