...
<section class="brand-hero">
  ...
  <div class="brand-hero__media brand-hero__media--compact">
    <div class="matrix-panel matrix-panel--contact">
      <div class="matrix-panel__hud">
        <span>SMARTFLOW // EXTERNAL MATERIALS</span>
        <span>MAT 01</span>
      </div>
  ...
  <section class="brand-card">
    <p class="brand-kicker">How To Use</p>
    <h2>这组资料适合怎么用</h2>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          <td>面向决策者说明价值</td>
          <td><a href="./value.html">价值说明</a></td>
          <td>解释效率、可控性和长期价值</td>
          <td>适合老板、业务负责人、项目负责人</td>
        </tr>
        <tr>
          <td>售前演示或方案沟通</td>
          <td><a href="../product/customer-flow.html">客户流程 / 交付</a></td>
          <td>把交付包、使用路径、热更新和边界讲清楚</td>
          <td>适合正式进入项目沟通阶段</td>
        </tr>
        <tr>
          <td>新同事快速对齐公开口径</td>
  ...
  <section class="brand-card">
    ...
    <div class="brand-link-grid">
      ...
      <a class="brand-link-card" href="./value.html">
        <span>Step 02</span>
        <strong>价值说明</strong>
        <p>再把“为什么值得听、为什么值得买、为什么值得继续推进”讲清楚。</p>
      </a>
      <a class="brand-link-card" href="../product/index.html">
        <span>Step 03</span>
        <strong>产品概览</strong>
        <p>如果要进一步深挖真实能力，再回到产品文档主线。</p>
      </a>
      <a class="brand-link-card" href="../contact.html#lead-form">
        <span>Step 04</span>
        <strong>联系我</strong>
        <p>如果已经进入合作或演示阶段，就直接进入沟通入口。</p>
      </a>
    </div>
  </section>
  ...
  <section class="brand-card brand-card--cta">
    <div class="brand-card__row">
      <div>
        ...
        <h2>如果你要讲给别人听，这里就是外部资料入口</h2>
        <p class="brand-lead">这组资料和产品文档不是重复关系，而是“表达方式”和“产品事实”的分工关系。</p>
      </div>
