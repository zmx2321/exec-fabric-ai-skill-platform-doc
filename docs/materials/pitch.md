    ...
    <div class="matrix-panel matrix-panel--contact">
      ...
      <div class="matrix-panel__canvas">
        ...
        <div class="matrix-panel__stack">
          <span class="matrix-panel__line"><span class="matrix-panel__key">problem</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">scripts exist</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">entry does not</span></span>
          <span class="matrix-panel__line"><span class="matrix-panel__key">platform</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">ai judge</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">controlled execution</span></span>
          <span class="matrix-panel__line"><span class="matrix-panel__key">delivery</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">tenant</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">url</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">update</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">isolation</span></span>
        </div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>05</td>
          <td>为什么客户愿意买单</td>
          <td>客户买的不是页面，而是效率、隔离和可持续更新</td>
          <td>人工操作 vs 平台执行对比图</td>
        </tr>
        <tr>
          <td>06</td>
          <td>平台内部闭环</td>
        ...
        <tr>
          <td>08</td>
          <td>安全与隔离优势</td>
          <td>平台强项不是更会说，而是只能在授权范围内做事</td>
          <td>租户、权限、确认、审计边界图</td>
        </tr>
        <tr>
          <td>09</td>
          <td>商业路径</td>
