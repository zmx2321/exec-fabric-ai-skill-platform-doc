...
<section class="brand-hero">
  <div>
    ...
    <div class="brand-hero__panel">
      ...
      <strong>The most effective introduction does not start by piling on technical terms. It starts by judging whether the other side is currently in the free path, local script-slot expansion, formal team collaboration, or enterprise delivery.</strong>
    ...
    <div class="brand-chip-list">
      <span class="brand-chip">30-second version</span>
      <span class="brand-chip">3-minute version</span>
      <span class="brand-chip">Compact structure</span>
      <span class="brand-chip">Conversation-ready</span>
    </div>
    <div class="brand-actions">
      <a class="cta-button cta-button--brand" href="./value.html">View the Value Framing</a>
  ...
  <section class="brand-grid brand-grid--two">
    ...
    <article class="brand-card">
      ...
      <h2>How to explain it in 3 minutes</h2>
  ...
  <section class="brand-card">
    ...
    <h2>Judge which layer the other side is in first, then decide how to explain it</h2>
    <table>
      <thead>
        <tr>
          <th>Current audience</th>
          <th>What to lead with</th>
          <th>What not to say first</th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>Lead with local script-slot expansion and lightweight paid add-ons</td>
          <td>Do not present personal expansion as the formal team edition</td>
          <td><a href="./membership-benefits-pricing.html">Membership and Pricing</a></td>
        </tr>
        <tr>
          <td>Teams preparing for multi-user collaboration</td>
          <td>Lead with the formal monthly or annual team-tenant path</td>
          <td>Do not frame the shared-SaaS route as if private deployment is the default</td>
          <td><a href="../product/personal-billing-membership.html">Billing and Membership</a></td>
        </tr>
        <tr>
  ...
  <section class="brand-card">
    ...
    <h2>How a short introduction deck can be structured</h2>
    <table>
      <thead>
        <tr>
          <th>Slide</th>
          <th>Title</th>
          <th>What this slide should make clear</th>
          <th>Suggested visual</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td>01</td>
          <td>Cover</td>
          <td>State the platform name and the one-line position clearly</td>
          <td>Main visual plus slogan</td>
        </tr>
        <tr>
          <td>02</td>
          <td>What problem are we solving</td>
          <td>Many companies already have scripts, interfaces, and workflows, but no unified execution entry</td>
          <td>Scattered scripts converging into one platform entry</td>
        </tr>
        <tr>
          <td>03</td>
          <td>What is the platform</td>
          <td>It is not a generic chat system. It is a trusted execution platform.</td>
          <td>A layered diagram showing the conversation layer above capabilities and permissions</td>
        </tr>
        <tr>
          <td>04</td>
          <td>Core delivery modes</td>
          <td>Standard shared-SaaS tenants and enterprise single-tenant delivery are the two real current paths</td>
          <td>A dual-path visual for shared SaaS and enterprise delivery</td>
        </tr>
        <tr>
          <td>05</td>
          <td>Why customers pay for it</td>
          <td>Customers are buying efficiency, isolation, and sustainable updates, not just a page</td>
          <td>Manual operation versus platform execution comparison</td>
        </tr>
        <tr>
          <td>06</td>
          <td>Execution loop</td>
          <td>User request to AI understanding to capability recommendation to confirmation to execution to result</td>
          <td>A horizontal flow diagram</td>
        </tr>
        <tr>
          <td>07</td>
        ...
        <tr>
          <td>08</td>
          <td>Security and isolation advantages</td>
          <td>The strength is not talking better. It is doing work only inside authorized boundaries.</td>
          <td>A boundary diagram for tenants, permissions, confirmation, and audit</td>
        </tr>
        <tr>
          <td>09</td>
          <td>Current stage and next step</td>
          <td>Stabilize the 1.0 delivery version first, then decide which parts deserve to be standardized into 2.0</td>
          <td>Version roadmap</td>
        </tr>
        <tr>
          <td>10</td>
          <td>Closing slide</td>
          <td>Close with one clear statement of value</td>
          <td>Main visual plus contact information</td>
        </tr>
      </tbody>
    </table>
  </section>
  ...
  <section class="brand-grid brand-grid--three">
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>Explain what is already usable now before talking about later expansion.</li>
      </ul>
    </article>
    <article class="brand-card">
      ...
      <ul class="brand-list">
        ...
        <li>A more standardized small-team usage pattern will continue to tighten, and the shared-SaaS formal frontend currently carries that standard team path.</li>
        <li>More capability types will gradually join the unified governance chain.</li>
      </ul>
    </article>
    <article class="brand-card">
      <p class="brand-kicker">Demo Order</p>
      <h2>Suggested explanation order</h2>
      <ol class="brand-list">
        <li>First judge whether the other side belongs to the free path, local script-slot expansion, the team edition, or enterprise delivery.</li>
        <li>Then explain the problem and the platform definition.</li>
        <li>Then show the matching experience path or the team-upgrade path.</li>
        <li>Then explain customer flow, delivery, and isolation boundaries.</li>
        <li>Finally add CLI or deployment details only when they are needed.</li>
      </ol>
    </article>
  </section>
  ...
  <section class="brand-card brand-card--cta">
    <div class="brand-card__row">
      <div>
        ...
        <h2>The value judgment can continue on the next page</h2>
        <p class="brand-lead">Continue into the value framing page to close the questions that business owners, operators, and delivery leads care about most.</p>
      </div>
