...
<section class="brand-hero">
    ...
    <div class="matrix-panel matrix-panel--contact">
      ...
      <div class="matrix-panel__canvas">
        ...
        <div class="matrix-panel__stack">
          <span class="matrix-panel__line"><span class="matrix-panel__key">public</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">experience</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">login</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">register</span></span>
          <span class="matrix-panel__line"><span class="matrix-panel__key">product</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">docs</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">delivery</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">deployment</span></span>
          <span class="matrix-panel__line"><span class="matrix-panel__key">local</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">cli</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">register</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">run</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">agent</span></span>
        </div>
  ...
  <section class="brand-grid brand-grid--four">
    <article class="brand-card">
      ...
      <h2>它不是普通聊天系统</h2>
      <p>AI 在这里主要承担裁决入口和能力推荐角色，真实目标是让脚本与流程进入可控执行链路。</p>
    </article>
    <article class="brand-card">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>当前已成体系</td>
          <td>产品、技术、售前</td>
          <td>讲平台是什么、怎么交付、怎么部署、怎么演进。</td>
        </tr>
        <tr>
          <td>CLI 文档</td>
          <td>当前已成体系</td>
          <td>开发者、本地接入场景</td>
          <td>解释当前已实现和未实现的命令边界。</td>
        </tr>
        <tr>
          <td>联系页</td>
          <td>当前正式入口</td>
