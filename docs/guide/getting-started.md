    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>当前正式公开体验页</td>
          <td>第一次体验的人</td>
          <td>它是真实入口，不是只用于截图展示的占位页；当前左侧是 Python `task_brief_demo.py`，右侧是 Shell `clean_log_demo.sh`，体验脚本来自正式目录 <code>exec-fabric-ai-skill-platform-script/testing/tenant_1000/experience/</code>。</td>
        </tr>
        <tr>
