...
<section class="brand-hero">
    ...
    <div class="matrix-panel matrix-panel--contact">
      ...
      <div class="matrix-panel__canvas">
        ...
        <div class="matrix-panel__stack">
          <span class="matrix-panel__line"><span class="matrix-panel__key">path_a</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">experience</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">login</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">product docs</span></span>
          <span class="matrix-panel__line"><span class="matrix-panel__key">path_b</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">local scripts</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">cli</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">manifest</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">run</span></span>
          <span class="matrix-panel__line"><span class="matrix-panel__key">path_c</span><span class="matrix-panel__punct">:</span> <span class="matrix-panel__value">customer delivery</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">tenant</span><span class="matrix-panel__sep"> / </span><span class="matrix-panel__value">hot update</span></span>
        </div>
  ...
  <section class="brand-card">
    <p class="brand-kicker">Public Entry</p>
    <h2>当前公开可走的正式入口</h2>
    <table>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          <td>产品文档</td>
          <td>解释平台是什么、怎么交付、怎么部署、怎么演进</td>
          <td>产品、售前、技术负责人</td>
          <td><a href="../product/index.html">产品概览</a></td>
        </tr>
        <tr>
          <td>CLI 文档</td>
  ...
  <section class="brand-card">
    <p class="brand-kicker">Role Based</p>
    <h2>不同角色，建议从哪里开始</h2>
    <div class="brand-grid brand-grid--four">
      <article class="brand-card brand-card--nested">
        <h3>个人开发者</h3>
        <p>先看快速开始，再看 CLI 指引，最后再判断是否需要更深的团队或企业路径。</p>
      </article>
      <article class="brand-card brand-card--nested">
        <h3>小团队负责人</h3>
