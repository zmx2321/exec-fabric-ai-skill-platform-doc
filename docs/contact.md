...
<div class="brand-page-shell">
  <section class="brand-hero">
    <div>
      ...
      <h1>联系我，继续聊 SmartFlow 的交付、产品和合作</h1>
      <p class="brand-lead">
        如果你在做企业业务自动化、平台化交付、私有部署，或者希望把已有脚本和流程升级成可治理的执行平台，
        这里可以继续深入沟通。
      </p>
      <div class="brand-chip-list">
        <span class="brand-chip">企业交付合作</span>
        <span class="brand-chip">团队版 / 企业版升级</span>
        <span class="brand-chip">私有化部署与数据自动化</span>
        <span class="brand-chip">本地脚本、CLI 与模板方案</span>
      </div>
      <div class="brand-actions">
        <a class="cta-button cta-button--brand" href="mailto:zmx2321@gmail.com">发邮件联系我</a>
    ...
    <div class="brand-hero__media brand-hero__media--compact">
      ...
      <div class="brand-hero__panel">
        ...
        <p>当前文档站用于统一展示平台介绍、能力说明、版本路线和合作联系方式。</p>
      </div>
    </div>
  </section>
  ...
  <section class="brand-card brand-card--cta">
    <div class="brand-card__row">
      ...
      <div class="brand-link-grid brand-link-grid--compact">
        ...
        <a class="brand-link-card" href="/product/capabilities">
          <span>Capabilities</span>
          <strong>核心能力</strong>
        </a>
        <a class="brand-link-card" href="/product/architecture">
          <span>Architecture</span>
          <strong>架构说明</strong>
        </a>
        <a class="brand-link-card" href="/product/editions">
          <span>Roadmap</span>
          <strong>版本路线</strong>
        </a>
      </div>
